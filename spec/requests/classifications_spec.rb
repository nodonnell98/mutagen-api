...
RSpec.describe 'Classifications', type: :request do
  ...
  describe 'GET /index' do
    it 'will not succeed if not signed in' do
      get '/api/v1/classifications', as: :json
  ...
  describe 'GET /show' do
    it 'will not succeed if not signed in' do
      get "/api/v1/classifications/#{weapon.id}", as: :json
  ...
  describe 'POST /create' do
    it 'will not succeed if not signed in' do
      post '/api/v1/classifications', params: {
        weapon: {
          name: 'Widowmaker',
          weapon_type: 'Sniper',
  ...
  describe 'PUT /update' do
    it 'will not succeed if not signed in' do
      put "/api/v1/classifications/#{weapon.id}", params: {
        weapon: {
          name: 'Edited Gun'
        }
      }
    ...
    context 'when signed in' do
      ...
      it 'successfully edits weapon with valid changes' do
        weapon_url = "/api/v1/classifications/#{weapon.id}"
  ...
  describe 'DELETE /destroy' do
    ...
    it 'will not succeed if not signed in' do
      delete "/api/v1/classifications/#{weapon2.id}", as: :json
    ...
    context 'when signed in' do
      ...
      it 'deletes a present record' do
        ...
        weapon_url = "/api/v1/classifications/#{weapon2.id}"

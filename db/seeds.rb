...
weapon1 = Weapon.create(name: 'Glock', weapon_type: 'Pistol', description: 'A basic pistol', range: '20', quality: 'common',
              dice_type: '4', dice_qty: '2', damage_type: 'kinetic', ammo: '3', proficiency: '2', character_ids: [character1.id])
weapon2 = Weapon.create(name: 'AR-57', weapon_type: 'Assault', description: 'A basic AR', range: '30', quality: 'common',
